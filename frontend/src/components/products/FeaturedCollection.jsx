    ...
    <section className="py-16 px-4 lg:px-8">
      <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center bg-gray-50 rounded-3xl">
        ...
        <div className="lg:w-1/2 p-8 text-center lg:text-left">
          ...
          <Link
            to="/collections/all"
            className="bg-black text-white px-6 py-3 rounded-lg text-lg hover:bg-gray-800 transition-colors duration-300"
          >
            Shop Now
          </Link>
        </div>
        ...
        <div className="lg:w-1/2">
          <img
            ...
            className="w-full h-[400px] lg:h-full object-cover lg:rounded-tr-3xl lg:rounded-br-3xl"
          />
        </div>
      </div>
    </section>
